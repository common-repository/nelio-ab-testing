...
export const Edit = ( {
	...
	const selectControlId = `nab-day-of-week-segmentation-rule__value-${ instanceId }`;
	const daysListOptions = Object.entries( daysList ).map(
	...
	return (
		<>
			...
			>
				<div className="nab-day-of-week-segmentation-rule">
					<StylizedSelectControl
						id={ selectControlId }
						isMulti
						className="nab-day-of-week-segmentation-rule__value"
						value={ values }
						onChange={ ( newValues ) =>
...
const CONDITION_LABEL_RECORD: Record< Attributes[ 'condition' ], string > = {
	'is-equal-to': _x( 'Day of visit is equal to', 'text', 'nelio-ab-testing' ),
	'is-not-equal-to': _x(
		'Day of visit is not equal to',
		'text',
		'nelio-ab-testing'
	),
};
